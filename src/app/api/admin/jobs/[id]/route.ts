...
const EDITABLE_FIELDS = [
  ...
  "report_notes",
  "mold_air_discussion",
  "mold_bulk_discussion",
  "mold_swab_discussion",
  "mold_report_notes",
  "mold_lab_name",
  "lead_report_summary",
  "lead_report_notes",
