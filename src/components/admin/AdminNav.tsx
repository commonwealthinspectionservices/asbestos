...
// Prospecting was removed 2026-09-19 at Tim's request, to be revisited
// later — the full code is preserved at the git tag `prospecting-archive`
// (the `prospects` table and its data are untouched).
