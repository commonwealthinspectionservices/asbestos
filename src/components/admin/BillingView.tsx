            ...
            <div className="flex flex-wrap gap-1.5">
              {FILTERS.map((f) => (
                <button
                  ...
                  className={`shrink-0 whitespace-nowrap rounded-lg px-4 py-2 text-sm font-medium ${!periodFilter && filter === f.key ? "bg-brand-600 text-white" : "bg-slate-100 text-slate-600"}`}
                >
                  {f.label}
                </button>
              ))}
